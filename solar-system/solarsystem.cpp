...
void SolarSystem::onDisplay()
{
    ...
    glLoadIdentity();
    // 指定当前的观察视景体
    gluPerspective(75.0f, 1.0f, 1.0f, 40000000.0);
    // 指定当前矩阵为视景矩阵堆栈应用之后的矩阵操作
    ...
    // 在main函数中初始化现实模式时使用了GLUT_DOUBLE
    // 需要使用glutSwapBuffers在绘制结束后实现双缓冲的缓冲区交换
    glutSwapBuffers();
}
